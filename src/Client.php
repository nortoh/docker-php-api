...
class Client extends \Docker\API\Runtime\Client\Client
{
    ...
    */
     ...
     */
    public function containerCreate(?\Docker\API\Model\ContainersCreatePostBody $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function putContainerArchive(string $id, ?string $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
    ...
    */
     ...
     */
    public function imageCommit(?\Docker\API\Model\ContainerConfig $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function networkConnect(string $id, ?\Docker\API\Model\NetworksIdConnectPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function networkDisconnect(string $id, ?\Docker\API\Model\NetworksIdDisconnectPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
    ...
    */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function nodeUpdate(string $id, ?\Docker\API\Model\NodeSpec $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function swarmInit(?\Docker\API\Model\SwarmInitPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function swarmJoin(?\Docker\API\Model\SwarmJoinPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function swarmUpdate(?\Docker\API\Model\SwarmSpec $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
    ...
    */
     ...
     */
    public function serviceCreate(?\Docker\API\Model\ServicesCreatePostBody $requestBody = null, array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
     ...
     */
    public function serviceUpdate(string $id, ?\Docker\API\Model\ServicesIdUpdatePostBody $requestBody = null, array $queryParameters = [], array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function secretUpdate(string $id, ?\Docker\API\Model\SecretSpec $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
    ...
    */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function configUpdate(string $id, ?\Docker\API\Model\ConfigSpec $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
    ...
    public static function create($httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        if (null === $httpClient) {
            ...
            $plugins = [];
            $uri = \Http\Discovery\Psr17FactoryDiscovery::findUriFactory()->createUri('/v1.36');
